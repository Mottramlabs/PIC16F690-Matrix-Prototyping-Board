...
Del_10uS		;10uS delay
		...
		nop						;Delay added to 16MHz only
		goto		DL_X1				;Jump
DL_X1		movwf   		Time_1          			;Load reg
DL_X2		decfsz  		Time_1,1        			;Skip next if zero
		goto		DL_X2				;Loop
		retlw   		0               			;Return
...
DL_01		decfsz  		Time_1,1        			;Skip next if zero
		goto		DL_01				;Loop
		retlw   		0               			;Return
...
DL_02Q		movlw   		.100                                    ;Load w
		movwf   		Time_2          			;Load reg
		goto		DL_02				;Jump
DL_02		call		Del_100uS				;Call 100uS delay
...
Del_1S		;1S delay, uses Del_100uS and has clear watchdog. Uses Timer_2 + Second + Timer_1
		...
		movwf   		Time_3          			;Load reg
		goto		DL_03				;Jump
DL_03		movlw   		.050	        	    		;Load w
		movwf   		Time_2          			;Load reg
DL_04		call		Del_100uS				;Call 100uS delay
		decfsz  		Time_2,1        			;Skip next if zero
		goto		DL_04				;Loop
